    ...
    >
      ...
      <div className={`sidebar-content  duration-300 mx-10 text-xl translate-x-3 ${open ? "mt-10" : "mt-0 sidebar-icon max-sm:translate-x-4"}`}>
        ...
        <div className={` ${open ? 'border-b':'border-0'} border-white mt-4`}>
          ...
          <div className="flex items-center py-2">
            <i title="التسليمات" className="fa-solid fa-file-lines cursor-pointer text-xl ml-4" />
            <h2 className={`text-xl text-white cursor-pointer  duration-300 ${!open && "scale-0"}`}>التسليمات</h2>
          </div>
        </div>

        <div className={` ${open ? 'border-b':'border-0'} border-white mt-4`}>
          <div className="flex items-center py-2">
          <i title='إدارة الملفات' className="fa-solid fa-folder-open cursor-pointer text-xl ml-4"/>
            <h2 className={`text-xl text-white cursor-pointer  duration-300 ${!open && "scale-0"}`}>إدارة الملفات</h2>
          </div>
          <div className="flex items-center py-2">
          <i title="تقارير و احصائيات" className="fa-solid fa-chart-simple cursor-pointer text-xl ml-4" />
            <h2 className={`text-xl text-white cursor-pointer  duration-300 ${!open && "scale-0"}`}>تقارير وإحصائيات</h2>
          </div>
        </div>
