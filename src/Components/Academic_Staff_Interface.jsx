...
import Sidebar_Academic_Staff from '../global/Sidebar_Academic_Staff';
  ...
  return (
    ...
    <div className="academic-staff-page w-full flex justify-between">
        ...
        <div className='certificates  grid grid-cols-3  max-lg:grid-cols-2 max-sm:grid-cols-1 max-sm:gap-y-16  justify-items-center '> 
          ...
          <div style={{backgroundColor:'#611013'}} className="relative w-38 h-38  text-white rounded-2xl flex items-center justify-center rotate-45 shadow-lg cursor-pointer hover:scale-105 duration-300">
            <span className="-rotate-45">شهادة بكالوريوس</span>
          </div>
          <div style={{backgroundColor:'#611013'}} className="relative w-38 h-38  text-white rounded-2xl flex items-center justify-center rotate-45 shadow-lg cursor-pointer hover:scale-105 duration-300 ">
            <span className="-rotate-45">شهادة ماجستير</span>
          </div>
          <div style={{backgroundColor:'#611013'}} className="relative w-38 h-38   text-white rounded-2xl flex items-center justify-center rotate-45 shadow-lg cursor-pointer hover:scale-105 duration-300 max-lg:col-span-2 max-sm:col-span-1 max-lg:text-center">
           ...
           {/*  الكتب الرسمية   */}
          <h1 style={{color:'#540C0F'}} className=' text-center mt-10 relative text-4xl font-bold px-4  mb-10 max-sm:mb-16 max-sm:mt-16 '>الكتب الرسمية</h1> 
          ...
          <div style={{backgroundColor:'#611013'}} className="relative w-38 h-38  text-white rounded-2xl flex items-center justify-center rotate-45 shadow-lg cursor-pointer hover:scale-105 duration-300 ">
           ...
           {/*  الدورات  */}
          <h1 style={{color:'#540C0F'}} className=' text-center mt-10 relative text-4xl font-bold px-4  mb-10 max-sm:mb-16 max-sm:mt-16'> الدورات</h1> 
          ...
          <div style={{backgroundColor:'#611013'}} className="relative w-38 h-38  text-white rounded-2xl flex items-center justify-center rotate-45 shadow-lg cursor-pointer hover:scale-105 duration-300">
            <span className="-rotate-45">دورة اختراق اخلاقي</span>
             ...
             {/*  كتب الاجازات  */}     
          <h1 style={{color:'#540C0F'}} className=' text-center mt-10 relative text-4xl font-bold px-4  mb-10 max-sm:mb-16 max-sm:mt-16'>كتب الاجازات</h1> 
