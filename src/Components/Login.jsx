      ...
      <div  className="flex justify-between max-sm:block ">
        ...
        <div style={{backgroundColor:'#F0EFEF',border:'solid 2px #CFCFCF',width:'480px',height:'550px'}} className='login-form text-center  mt-20  rounded-3xl  max-sm:mb-8'>
          ...
          <form action="">
            ...
            <button style={{backgroundColor:'var(--primary-color)'}} className='w-40 h-14 mt-8 text-xl rounded-xl  text-white cursor-pointer transition-opacity hover:opacity-80'> <Link to="Academic_Staff_Home">تسجيل الدخول</Link> </button>
          </form>
